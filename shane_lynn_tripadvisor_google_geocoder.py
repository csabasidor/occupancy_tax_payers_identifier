...
datass = psql.read_sql("select * from tripadvisortest", conn_1)

data = pd.DataFrame(datass)
conn_1.close()

#print(pd.DataFrame(results))
#results.to_sql(str(results), engine, if_exists='append')
#conn.close()
...
datas.to_sql('tripadvisor_geoceded', engine, if_exists='replace')
